...
namespace vjf.SyncTool.Business
{
    ...
    public class ExistsCommand : CommandBase<ExistsCommand>
    {
        ...
        private vjf.SyncTool.Business.IGeneratedCriteria Criteria { get; set; }
        public bool Result { get; private set; }

        private void BeforeServer(vjf.SyncTool.Business.IGeneratedCriteria criteria)
        {
            Criteria = criteria;
            Result = false;
        }
        ...
        public static bool Execute<T>(T criteria) where T : vjf.SyncTool.Business.IGeneratedCriteria
        {
        ...
        public static void ExecuteAsync<T>(T criteria, EventHandler<DataPortalResult<ExistsCommand>> handler) where T : vjf.SyncTool.Business.IGeneratedCriteria
        {
            if (!CanExecuteCommand())
                throw new System.Security.SecurityException("Not authorized to execute command");
