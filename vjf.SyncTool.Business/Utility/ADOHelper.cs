    ...
    public static class ADOHelper
    {
        ...
        public static string ConnectionString
        {
            get
            {
                ...
                {
                    _connectionString = System.Configuration.ConfigurationManager.ConnectionStrings["VjifenConnectionString"].ConnectionString;
                }
        ...
        /// </summary>
        public static MySqlParameter[] SqlParameters(Dictionary<string, object> bag)
        {
        ...
        /// Returns an array of SqlParameters
        /// </summary>
        public static MySqlParameter[] SqlParameters(Dictionary<string, object> bag, bool includePrefix)
        {
            string prefix = includePrefix ? "@p_" : String.Empty;
            return new List<MySqlParameter>(bag.Select(pair => new MySqlParameter(String.Format("{0}{1}", prefix, pair.Key), pair.Value))).ToArray();
        }
